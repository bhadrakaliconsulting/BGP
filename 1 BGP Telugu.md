...
🏪 మీరు Hyderabad నుండి Mumbai కి letter పంపాలంటే — మీరు Post Office కి Velli submit cheastharu. Post Office Vallu best route enchukuntaru kadhah ?  — Same alagalea BGP panicheasthundhi BG, Packets కి best route choose చేస్తుంది.


Internet లో exactly same గా పని చేస్తుంది BGP. 
